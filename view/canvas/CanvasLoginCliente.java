...
public class CanvasLoginCliente extends javax.swing.JPanel {

    BufferedImage imgLogin;
    
    public CanvasLoginCliente() {
        try {
            initComponents();
    ...
    private void initComponents() {
        ...
        jLabelCliente.setFont(new java.awt.Font("Tw Cen MT Condensed Extra Bold", 0, 36)); // NOI18N
    ...
    private void jBAcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBAcessarActionPerformed
        ...
        try {
            ...
            sucesso = loginController.validarUsuarioCliente(tFEmail.getText(), senha);
